...
public class NurseDTO {
	...
	public NurseDTO(int nurseid, String nursefirstname, String nurselastname, String nurseemail, String nursemobile,String nursepassword) {
		super();
	...
	public String toString() {
		return "NurseDTO [nurseid=" + nurseid + ", nursefirstname=" + nursefirstname + ", nurselastname="
